...
const groupAutoDownloadPlugin = {
    command: 'group-autodownload',
    aliases: ['autodownload', 'downloadgroup'],
    category: 'utility',
    description: 'Automatically download shared links in the configured group.',
    usage: '.group-autodownload',
    handler: handleGroupAutoDownload,
};

export default groupAutoDownloadPlugin;
